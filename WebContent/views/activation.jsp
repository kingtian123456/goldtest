...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>激活码管理-ETENIOT LABS-智城慧商</title>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white">
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title">序列码管理
                        <a onclick="Show()" class="btn green btn-outline btn-circle btn-md active pull-right">新增序列码</a>
                    </h3>
                    <!-- END PAGE TITLE-->
                                ...
                                <div class="portlet-body">
                                    <div class="table-scrollable ">
                                        <table class="table table-striped table-hover" id="mytab">
                                        	<thead>
	                                        	<tr>
	                                        		<th>序列ID</th><th>序列号</th><th>激活帐号</th><th>是否被验证</th><th>是否被派送</th><th>验证时间</th><th>操作</th>
	                                        	</tr>  	
                                        	</thead>
                                        	<tbody>
                                    		</tbody>
                ...
                <div class="modal-dialog modal-md" role="document" style="margin: auto;top: 50%;transform: translate(0,-50%);">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">新增序列码<span class="small"></span></h4>
                        </div>
                        <div class="modal-body">
                            
                            <form class="form-horizontal" id="InsertLabs" role="form">
                                <div class="form-body">
                                    
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">新增数目</label>
                                        <div class="col-md-8">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary" onclick="InsertLabs()">提交
                                    </button>
                                </div>
                            </form>
                        </div>
            ...
            <div class="modal fade bs-example-modal-md" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" id="editModals">
                <div class="modal-dialog modal-md" role="document" style="margin: auto;top: 50%;transform: translate(0,-50%);">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                            <h4 class="modal-title">修改序列码状态</h4>
                        </div>
                        <div class="modal-body">
                            
                            <form class="form-horizontal" id="UpdateLabs" role="form">
                                <div class="form-body">
                                	
                                	<input type="hidden" name="labsId" value="">
                                    
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">派发状态:</label>
                                        <div class="col-md-8">
                                            <input type="radio" name="labsSend" value="0" checked="checked" >未派发
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <input type="radio" name="labsSend" value="1">已派发
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                                    <button type="button" class="btn btn-primary" onclick="UpdateLabs()">提交
                                    </button>
                                </div>
                            </form>
                        </div>
        ...
        <!-- BEGIN 自定义JS -->
        <script src="../assets/mydoc/js/activation.js" type="text/javascript" defer></script>
        <!-- end 自定义JS -->
    </body>
