...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white">
        ...
        <div class="page-container">
                            ...
                            <div class="portlet light portlet-fit bordered">
                                <div class="portlet-title">
                                    <div class="device-font">
                                        ...
                                        <label class="device-font-content"><span class="device-total-num">${product.dvg_devnum}</span>个</label>
                                ...
                                <div class="portlet-body">
                                    <form class="form-inline" role="form" method="get" action="${pageContext.request.contextPath}/selectProductDevicesinfo">
                                        <input type="text" class="form-control" name="logtxt" placeholder="输入设备ID或者设备名称" id="username">
                                        <button type="submit" class="btn blue" >查询</button>
                                        <a href="javascript:;" class="btn green btn-outline btn-circle btn-md active pull-right" id="addDevBtn">添加设备</a>
                                    </form> 
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="devtd">
                                                        ...
                                                        <p class="devmsg">创建时间:<fmt:formatDate value="${dl.dev_intime}" pattern="yyyy-MM-dd HH:mm:ss"/></p>
                                                    </td>
                                                    <td class="table-manage">
                                                        <div>
                                                            <i class="fa fa-edit" onclick="test('${dl.dev_name}','${dl.dev_vnum}','${dl.dev_type}','${dl.dev_code}','${dl.dev_forward}','${dl.dev_forport}')" ></i>
                                                            <i class="fa fa-trash" onclick="math('${dl.dev_id}','${dl.dev_code}','${dl.dev_sumnum}')" ></i>
                                                            <i class="fa fa-info" onclick="kiths('${dl.dev_name}','${dl.dev_vnum}','${dl.dev_type}','${dl.dev_forward}','${dl.dev_forport}')" ></i>
                                                            <a href="${pageContext.request.contextPath}/views/deviceData.jsp?dev_code=${dl.dev_code}"><i class="fa fa-columns"></i></a>
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            <c:if test="${dl.dev_ispassca == 1}">
                                                            	<i class="fa fa-angle-right" onclick="Lower('${dl.dev_code}')"></i>
                                                            </c:if>
                                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                                            <a href="${pageContext.request.contextPath}/Communication?dev_code=${dl.dev_code}"><i class="fa fa-mortar-board"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tbody>
                ...
                <!-- 分页 -->
                     <div class="text-center">
                                        <ul class="pagination">
       									<c:choose>  
                                            ...
                                            <c:forEach var="j" begin="${begin}" end="${end}">  
            									...
            									<%--不是当前页--%>  
	            									<c:otherwise>  
	               								 		<li><a href="${pageContext.request.contextPath}/selectProductDevicesinfo?page=${j}">${j}</a></li>  
	            									</c:otherwise>  
        										</c:choose>  
    										</c:forEach>
    									...
    									<c:choose>  
										    ...
										    <c:otherwise>  
										        <%-- 点击到尾页--%>  
										        <li><a href="${pageContext.request.contextPath}/selectProductDevicesinfo?page=${zbmpage}">»</a></li>  
										    </c:otherwise>  
										</c:choose>
										</ul>
                            ...
                            <form class="form-horizontal" id="productmodelssi" role="form">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" name="dev_vnum1" class="form-control" placeholder="字符或者数字组成的字符串，最多不超过16个字符。">
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary" id="tijiaoonexiugai">提交
                                    </button>
                                </div>
                            </form>
                        </div>
            ...
            <!-- infoModal模态框 end -->
            <!-- trashModal begin -->
            <div class="modal fade bs-example-modal-md" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" id="trashModal">
                <div class="modal-dialog modal-md" role="document" style="margin: auto;top: 50%;transform: translate(0,-50%);">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" id="deletedevice" >确定</button>
            ...
            <!-- 添加设备 模态框 begin -->
                <!-- addDevice 模态框 begin -->
                <div class="modal fade bs-example-modal-md" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" id="addDevModal">
                <div class="modal-dialog modal-md" role="document" style="margin: auto;top: 50%;transform: translate(0,-50%);">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                        ...
                        <div class="modal-body">
                            ...
                            <form class="form-horizontal" id="productmodel" role="form">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                                    <button type="button" class="btn btn-primary" id="tijiaoone">提交
                                    </button>
                                </div>
                            </form>
                        </div>
