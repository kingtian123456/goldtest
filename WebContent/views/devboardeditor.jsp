...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>修改商品-ETENIOT LABS-智城慧商</title>
                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-dark sbold uppercase">正在修改商品</span>
                                    </div> 
                                </div>
                                <form action="../updateCommodityOne" method="post" id="Commodtiyform" class="form-horizontal">
                                    ...
                                    <!-- BEGIN FORM-->
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <select style="width:510px;height:35px;" name="sortId" id="selectoptin">
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
...
<![endif]-->
        ...
        <script src="../assets/mydoc/js/devboardeditor.js"  type="text/javascript" ></script>
    </body>
